...
class KMedoidsQuantisation:
    ...
    def train_model(self, features):
        ...
        for i in range(self.sub_spaces):
            ...
            kmedoids = KMedoids(n_clusters=self.K, random_state=0).fit(sub_features)

            self.C.append(kmedoids)
    ...
    def encode(self, features):
        ...
        for i in range(self.sub_spaces):
            ...
            nearest = kmedoids.predict(sub_features)
